...
var nodes = [
	...
	{ id: 10, tag: 'people', name: 'Arvel Crynyd', target: [5] },
	{ id: 11, tag: 'people', name: 'Ayla Secura', target: [0, 1, 2] },
	{ id: 12, tag: 'people', name: 'BB8', target: [6] },
	{ id: 13, tag: 'people', name: 'Bail Prestor Organa', target: [1, 2] },
	{ id: 14, tag: 'people', name: 'Barriss Offee', target: [1] },
	{ id: 15, tag: 'people', name: 'Ben Quadinaros', target: [0] },
	{ id: 16, tag: 'people', name: 'Beru Whitesun lars', target: [1, 2, 3] },
	{ id: 17, tag: 'people', name: 'Bib Fortuna', target: [5] },
	{ id: 18, tag: 'people', name: 'Biggs Darklighter', target: [3] },
	{ id: 19, tag: 'people', name: 'Boba Fett', target: [1, 4, 5] },
	{ id: 20, tag: 'people', name: 'Bossk', target: [4] },
	{ id: 21, tag: 'people', name: 'C-3PO', target: [0, 1, 2, 3, 4, 5] },
	{ id: 22, tag: 'people', name: 'Captain Phasma', target: [6] },
	{ id: 23, tag: 'people', name: 'Chewbacca', target: [2, 3, 4, 5, 6] },
	{ id: 24, tag: 'people', name: 'Cliegg Lars', target: [1] },
	{ id: 25, tag: 'people', name: 'Cordé', target: [1] },
	{ id: 26, tag: 'people', name: 'Darth Maul', target: [0] },
	{ id: 27, tag: 'people', name: 'Darth Vader', target: [2, 3, 4, 5] },
	{ id: 28, tag: 'people', name: 'Dexter Jettster', target: [1] },
	{ id: 29, tag: 'people', name: 'Dooku', target: [1, 2] },
	{ id: 30, tag: 'people', name: 'Dormé', target: [1] },
	{ id: 31, tag: 'people', name: 'Dud Bolt', target: [0] },
	{ id: 32, tag: 'people', name: 'Eeth Koth', target: [0, 2] },
	{ id: 33, tag: 'people', name: 'Finis Valorum', target: [0] },
	{ id: 34, tag: 'people', name: 'Finn', target: [6] },
	{ id: 35, tag: 'people', name: 'Gasgano', target: [0] },
	{ id: 36, tag: 'people', name: 'Greedo', target: [3] },
	{ id: 37, tag: 'people', name: 'Gregar Typho', target: [1] },
	{ id: 38, tag: 'people', name: 'Grievous', target: [2] },
	{ id: 39, tag: 'people', name: 'Han Solo', target: [3, 4, 5, 6] },
	{ id: 40, tag: 'people', name: 'IG-88', target: [4] },
	{ id: 41, tag: 'people', name: 'Jabba Desilijic Tiure', target: [0, 3, 5] },
	{ id: 42, tag: 'people', name: 'Jango Fett', target: [1] },
	{ id: 43, tag: 'people', name: 'Jar Jar Binks', target: [0, 1] },
	{ id: 44, tag: 'people', name: 'Jek Tono Porkins', target: [3] },
	{ id: 45, tag: 'people', name: 'Jocasta Nu', target: [1] },
	{ id: 46, tag: 'people', name: 'Ki-Adi-Mundi', target: [0, 1, 2] },
	{ id: 47, tag: 'people', name: 'Kit Fisto', target: [0, 1, 2] },
	{ id: 48, tag: 'people', name: 'Lama Su', target: [1] },
	{ id: 49, tag: 'people', name: 'Lando Calrissian', target: [4, 5] },
	{ id: 50, tag: 'people', name: 'Leia Organa', target: [2, 3, 4, 5, 6] },
	{ id: 51, tag: 'people', name: 'Lobot', target: [4] },
	{ id: 52, tag: 'people', name: 'Luke Skywalker', target: [2, 3, 4, 5, 6] },
	{ id: 53, tag: 'people', name: 'Luminara Unduli', target: [1, 2] },
	{ id: 54, tag: 'people', name: 'Mace Windu', target: [0, 1, 2] },
	{ id: 55, tag: 'people', name: 'Mas Amedda', target: [0, 1] },
	{ id: 56, tag: 'people', name: 'Mon Mothma', target: [5] },
	{ id: 57, tag: 'people', name: 'Nien Nunb', target: [5] },
	{ id: 58, tag: 'people', name: 'Nute Gunray', target: [0, 1, 2] },
	{ id: 59, tag: 'people', name: 'Obi-Wan Kenobi', target: [0, 1, 2, 3, 4, 5] },
	{ id: 60, tag: 'people', name: 'Owen Lars', target: [1, 2, 3] },
	{ id: 61, tag: 'people', name: 'Padmé Amidala', target: [0, 1, 2] },
	{ id: 62, tag: 'people', name: 'Palpatine', target: [0, 1, 2, 4, 5] },
	{ id: 63, tag: 'people', name: 'Plo Koon', target: [0, 1, 2] },
	{ id: 64, tag: 'people', name: 'Poe Dameron', target: [6] },
	{ id: 65, tag: 'people', name: 'Poggle the Lesser', target: [1, 2] },
	{ id: 66, tag: 'people', name: 'Quarsh Panaka', target: [0] },
	{ id: 67, tag: 'people', name: 'Qui-Gon Jinn', target: [0] },
	{ id: 68, tag: 'people', name: 'R2-D2', target: [0, 1, 2, 3, 4, 5, 6] },
	{ id: 69, tag: 'people', name: 'R4-P17', target: [1, 2] },
	{ id: 70, tag: 'people', name: 'R5-D4', target: [3] },
	{ id: 71, tag: 'people', name: 'Ratts Tyerell', target: [0] },
	{ id: 72, tag: 'people', name: 'Raymus Antilles', target: [2, 3] },
	{ id: 73, tag: 'people', name: 'Rey', target: [6] },
	{ id: 74, tag: 'people', name: 'Ric Olié', target: [0] },
	{ id: 75, tag: 'people', name: 'Roos Tarpals', target: [0] },
	{ id: 76, tag: 'people', name: 'Rugor Nass', target: [0] },
	{ id: 77, tag: 'people', name: 'Saesee Tiin', target: [0, 2] },
	{ id: 78, tag: 'people', name: 'San Hill', target: [1] },
	{ id: 79, tag: 'people', name: 'Sebulba', target: [0] },
	{ id: 80, tag: 'people', name: 'Shaak Ti', target: [1, 2] },
	{ id: 81, tag: 'people', name: 'Shmi Skywalker', target: [0, 1] },
	{ id: 82, tag: 'people', name: 'Sly Moore', target: [1, 2] },
	{ id: 83, tag: 'people', name: 'Tarfful', target: [2] },
	{ id: 84, tag: 'people', name: 'Taun We', target: [1] },
	{ id: 85, tag: 'people', name: 'Tion Medon', target: [2] },
	{ id: 86, tag: 'people', name: 'Wat Tambor', target: [1] },
	{ id: 87, tag: 'people', name: 'Watto', target: [0, 1] },
	{ id: 88, tag: 'people', name: 'Wedge Antilles', target: [3, 4, 5] },
	{ id: 89, tag: 'people', name: 'Wicket Systri Warrick', target: [5] },
	{ id: 90, tag: 'people', name: 'Wilhuff Tarkin', target: [2, 3] },
